...
*/
        ...
        let angle_incremento = 360 / numberOfPoints;
        let angleInRadians_incremento = (angle_incremento / 180) * Math.PI;
        let angleInRadians = 0;
        
        for(i; i < numberOfPoints; i++) {
            x1 = radius0 * Math.cos(angleInRadians) + x0;
            y1 = radius0 * Math.sin(angleInRadians) + y0;
            x2 = radius1 * Math.cos(angleInRadians) + x0;
            y2 = radius1 * Math.sin(angleInRadians) + y0;
            x3 = radius2 * Math.cos(angleInRadians) + x0;
            y3 = radius2 * Math.sin(angleInRadians) + y0;
            ...
            angleInRadians += angleInRadians_incremento;
        }
        ...
        points = [new THREE.Vector3(0.0, 0.0), new THREE.Vector3(0.5 * radius, 0.0)];
        geometry = new THREE.BufferGeometry().setFromPoints(points);
        ...
        points = [new THREE.Vector3(0.0, 0.0), new THREE.Vector3(0.7 * radius, 0.0)];
        geometry = new THREE.BufferGeometry().setFromPoints(points);
        material = new THREE.LineBasicMaterial({ color : handsHMColor });
    ...
    update() {
        ...
        angle = Math.PI / 2.0 - 2.0 * Math.PI * time[1] / 60.0 + (this.handS.rotation.z / 60);
        ...
        angle = Math.PI / 2.0 - 2.0 * Math.PI * time[0] / 12.0 + (this.handM.rotation.z / 10);
